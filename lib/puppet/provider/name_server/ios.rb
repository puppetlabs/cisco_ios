...
class Puppet::Provider::NameServer::NameServer < Puppet::ResourceApi::SimpleProvider
  ...
  def update(context, _name, should)
    array_of_commands_to_run = Puppet::Provider::NameServer::NameServer.commands_from_instance(should)
  ...
  def delete(context, name)
    ...
    array_of_commands_to_run = Puppet::Provider::NameServer::NameServer.commands_from_instance(clear_hash)
    array_of_commands_to_run.each do |command|
      context.device.run_command_conf_t_mode(command)
    end
  end
