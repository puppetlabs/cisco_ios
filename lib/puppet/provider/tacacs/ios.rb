...
class Puppet::Provider::Tacacs::Tacacs < Puppet::ResourceApi::SimpleProvider
  ...
  def self.command_from_instance(should)
    ...
    set_command = ''
    set_command << Puppet::Utility.convert_tacacs_key(commands_hash, should, parent_device)
    set_command << Puppet::Utility.convert_tacacs_source_interface(commands_hash, should, parent_device)
    set_command << Puppet::Utility.convert_tacacs_timeout(commands_hash, should, parent_device)
  end
