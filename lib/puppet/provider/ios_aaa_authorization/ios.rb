...
class Puppet::Provider::IosAaaAuthorization::IosAaaAuthorization
  ...
  def commands_hash
    Puppet::Provider::IosAaaAuthorization::IosAaaAuthorization.commands_hash
  end

  def get(context)
    output = context.device.run_command_enable_mode(PuppetX::CiscoIOS::Utility.get_values(commands_hash))
    return [] if output.nil?
    Puppet::Provider::IosAaaAuthorization::IosAaaAuthorization.instances_from_cli(output)
  end
  ...
  def update(context, _name, should)
    array_of_commands_to_run = Puppet::Provider::IosAaaAuthorization::IosAaaAuthorization.commands_from_instance(should)
  ...
  def delete(context, _name, is)
    is[:ensure] = 'absent'
    array_of_commands_to_run = Puppet::Provider::IosAaaAuthorization::IosAaaAuthorization.commands_from_instance(is)
    array_of_commands_to_run.each do |command|
      context.device.run_command_conf_t_mode(command)
    end
  end
