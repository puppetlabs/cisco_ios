...
RSpec.describe Puppet::Provider::SnmpUser::SnmpUser do
  ...
  describe '#get' do
    ...
    context 'with some v1 users' do
      ...
      it {
        expect(provider.get(context)).to eq [{ name: 'alpha v1', username: 'alpha', ensure: :present, roles: 'public', version: 'v1' }]
      }
    end
...
EOS
      ...
      it {
        expect(provider.get(context)).to eq [
          { name: 'bravo v3', ensure: :present, username: 'bravo', roles: 'private', version: 'v3', auth: 'md5', engine_id: '800000090300001EBE6E712C', privacy: 'AES128' },
          { name: 'charlie v3', ensure: :present, username: 'charlie', roles: 'public', version: 'v3', auth: 'md5', engine_id: '800000090300001EBE6E712C', privacy: 'AES192' },
        ]
      }
    end
  end
  ...
  describe '#create' do
    it 'runs run_command_conf_t_mode for a v1 user' do
      ...
      provider.create(context, 'delta v1', name: 'delta v1', ensure: :present, username: 'delta', version: 'v1', roles: 'private')
    end
    it 'runs run_command_conf_t_mode for a v3 user' do
      ...
      should = { name: 'echo v3', ensure: :present, username: 'echo', version: 'v3', roles: 'private', auth: 'md5', password: 'auth_pass', privacy: 'aes 128', private_key: 'priv_pass' }
  ...
  describe '#update' do
    it 'runs run_command_conf_t_mode for a v1 user' do
      ...
      is = { name: 'foxtrot v1', ensure: :present, username: 'foxtrot', roles: 'private', version: 'v1' }
      should = { name: 'foxtrot v2', ensure: :present, username: 'foxtrot', roles: 'private', version: 'v2' }
    ...
    it 'runs run_command_conf_t_mode for a v3 user' do
      ...
      is = { name: 'golf v3', ensure: :present, username: 'golf', roles: 'private', version: 'v3', auth: 'md5', password: 'auth_pass', privacy: 'aes 128', private_key: 'priv_pass' }
      should = { name: 'golf v3', ensure: :present, username: 'golf', roles: 'public', version: 'v3', auth: 'md5', password: 'auth_pass', privacy: 'aes 128', private_key: 'priv_pass' }
  ...
  describe '#delete' do
    it 'runs run_command_conf_t_mode for v1 user' do
      ...
      provider.delete(context, 'hotel v1', name: 'hotel v1', ensure: :absent, username: 'hotel', version: 'v1', roles: 'private')
    end
    it 'runs run_command_conf_t_mode for a v3 user' do
      ...
      should = { name: 'indigo v3', ensure: :absent, username: 'indigo', version: 'v3', roles: 'private', auth: 'md5', password: 'auth_pass', privacy: 'aes 128', private_key: 'priv_pass' }
