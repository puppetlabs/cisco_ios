...
group :development do
  ...
  # Collection pinned to avoid dependency errors around the inclusion of puppet-litmus
  gem "puppet-module-posix-dev-r#{minor_version}", '= 0.3.15',       require: false, platforms: [:ruby]
